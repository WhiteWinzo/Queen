...
module.exports = {
    VERSION: '🌀Queen Bot v1.0',
    CHANNEL: 'https://t.me/',
    SESSION: process.env.QUEEN_SESSION === undefined ? '' : process.env.QUEEN_SESSION,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 𝚀𝚄𝙴𝙴𝙽 ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 𝚀𝚄𝙴𝙴𝙽 ²⁰²²' : process.env.CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/f2dCVX6/Queen-Bot.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/f2dCVX6/Queen-Bot.jpg' : process.env.ALIVE_LOGO,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'QUEEN USER' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'QueenBOt' : process.env.BOT_NAME,
    ...
    CAPTION_MSG: process.env.CAPTION_MSG === undefined ? 'copyright (c) 2021 Queen bot' : process.env.CAPTION_MSG,
    ...
    Support4: "94705193038-1630672792",
