...
module.exports = {
    VERSION: '🌀Queen 1.0 beta',
    CHANNEL: 'https://t.me/DarkWinzo',
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'DarkWinzo' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Queen' : process.env.BOT_NAME,
    ...
    CAPTION_MSG: process.env.CAPTION_MSG === undefined ? 'copyright (c) 2022 Queenbot' : process.env.CAPTION_MSG,
