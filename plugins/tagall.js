...
Queen.addCommand({pattern: 'tagall ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC, deleteCommand: false  }, (async (message, match) => {
...
Queen.addCommand({pattern: 'stam$', fromMe: true, desc: stag_dsc, deleteCommand: false  }, (async (message, match) => {
