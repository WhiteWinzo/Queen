...
Queen.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Queen.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Queen.addCommand({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {
    if (!AFK.isAfk) {
